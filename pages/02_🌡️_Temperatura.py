...
# ----------------------------
# Estruturação para Temperatura (MODIS MOD11)
# ----------------------------
st.header("Análise de Temperatura (MODIS MOD11)")

# Carregar o conjunto de dados MODIS MOD11 (Temperatura)
...
# Gráfico anual com Plotly (linha laranja)
...
# Agrupar por mês para calcular a média de temperatura mensal
df_monthly_temp_avg = df_monthly_temp.groupby("month").mean().reset_index()

# Gráfico mensal com Plotly (linha laranja)
...
fig_ts_temp.update_traces(line_color="#ffbb33", selector=dict(mode='lines'))  # Linha principal em laranja claro
...
# Complemento: mostrar ano mais quente e mais frio
...
# Complemento visual: boxplot da temperatura anual
fig_box_temp = px.box(
